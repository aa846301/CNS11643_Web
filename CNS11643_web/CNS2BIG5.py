...
def update_char_code_big5(file_path):
...
update_char_code_big5('Open_Data/MapingTables/Big5/CNS2BIG5_Big5E.txt')
update_char_code_big5('Open_Data/MapingTables/Big5/CNS2BIG5.txt')
update_char_code_big5('Open_Data/MapingTables/Big5/CNS2BIG5_符號.txt')
update_char_code_big5('Open_Data/MapingTables/Big5/CNS2BIG5_七個倚天外字.txt')